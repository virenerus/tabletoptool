...
public interface ChatParserConstants {
  ...
  int DIVISION = 30;
  /** RegularExpression Id. */
  int PARANTHESES_LEFT = 31;
  /** RegularExpression Id. */
  int PARANTHESES_RIGHT = 32;
  /** RegularExpression Id. */
  int NUMBER = 33;
  /** RegularExpression Id. */
  int DICE_D = 34;
  ...
  int DICE_SUCCESS = 37;
  /** RegularExpression Id. */
  int DICE_EXPLODING_SUCCESS = 38;
  /** RegularExpression Id. */
  int DICE_EXPLODING = 39;
  /** RegularExpression Id. */
  int DICE_OPEN = 40;
  /** RegularExpression Id. */
  int DICE_HERO_STUN = 41;
  /** RegularExpression Id. */
  int DICE_HERO_BODY = 42;
  /** RegularExpression Id. */
  int DICE_FUDGE = 43;
  /** RegularExpression Id. */
