...
import net.rptools.maptool.script.mt2api.tokenfilter.AllFilter;
import net.rptools.maptool.script.mt2api.tokenfilter.ExposedFilter;
import net.rptools.maptool.script.mt2api.tokenfilter.NPCFilter;
import net.rptools.maptool.script.mt2api.tokenfilter.OwnedFilter;
import net.rptools.maptool.script.mt2api.tokenfilter.PCFilter;
import net.rptools.maptool.script.mt2api.tokenfilter.StateFilter;
