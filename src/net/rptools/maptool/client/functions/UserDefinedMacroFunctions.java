...
public class UserDefinedMacroFunctions implements Function {
	...
	private final Map<String, FunctionDefinition> userDefinedFunctions = new HashMap<String, FunctionDefinition>();
	private final Map<String, FunctionRedefinition> redefinedFunctions = new HashMap<String, FunctionRedefinition>();
