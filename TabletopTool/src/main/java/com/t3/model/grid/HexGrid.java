...
public abstract class HexGrid extends Grid {
	...
	static {
		try {
			pathHighlight = ImageUtil.getCompatibleImage("com/t3/client/image/hexBorder.png");
...
//		edgeProjection = Math.sqrt(edgeLength * edgeLength - minorRadius * minorRadius); // Pythagorus
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.t3.model.Grid#validateMove(java.awt.Rectangle, int, int, java.awt.geom.Area)
	 */
