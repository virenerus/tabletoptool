...
import com.t3.model.drawing.Cross;
...
public class CrossTopologyTool extends AbstractDrawingTool implements MouseMotionListener {
	...
	public CrossTopologyTool() {
		try {
			setIcon(new ImageIcon(ImageIO.read(getClass().getClassLoader().getResourceAsStream("com/t3/client/image/tool/top-blue-cross.png"))));
