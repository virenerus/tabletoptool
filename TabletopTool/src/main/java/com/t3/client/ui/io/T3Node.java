 ...
 * TabletopTool data.  If there is no associated TabletopTool data the <code>Object</code>
...
public class T3Node {
	 ...
	 * that doesn't have a corresponding TabletopTool object to go with it.  This should only
	 ...
	 * the tree node and an object that represents one unit of TabletopTool application data,
	 ...
	 * the heirarchy of data, but not an actual TabletopTool object.  This is fairly rare except
	 ...
	 * @param o the TabletopTool {@code Object} to be stored with this node
	 */

	public T3Node(String n, Object o) {
		name = n;
		object = o;
	}
	
	public T3Node(String n) {
		this(n, null);
	}
	...
	public boolean equals(Object obj) {
		if (obj == this)
			return true;
		if (obj instanceof T3Node) {
			T3Node mtn = (T3Node) obj;
