...
public class InitiativeListCellRenderer extends JPanel implements ListCellRenderer {
	 ...
	 */
	public static final Icon CURRENT_INDICATOR_ICON = new ImageIcon(InitiativePanel.class.getClassLoader().getResource("com/t3/client/image/currentIndicator.png"));
	...
	public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
		...
		if (TabletopTool.getFrame().getInitiativePanel().hasGMPermission() && token.getGMName() != null && token.getGMName().trim().length() != 0)
	...
	public class InitiativeListIcon extends ImageIcon {
		 ...
		 * 
		 * @param aTokenInitiative
		 *            The initiative item being rendered
		 */
