...
import com.t3.client.ui.macrobuttons.buttons.TransferData;
		...
		try {
			...
			if (panelClass.equals("GlobalPanel")) {
				...
				if (!tempProperties.isDuplicateMacro("CampaignPanel", null)){
					new MacroButtonProperties(panelClass, TabletopTool.getCampaign().getMacroButtonNextIndex(), tempProperties);
				}
