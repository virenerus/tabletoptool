...
public class TokenUtilTest {
	...
	public void testGuessTokenType() throws Exception {
		...
		AssertJUnit.assertEquals(Token.TokenShape.SQUARE, TokenUtil.guessTokenType(img));
		...
		AssertJUnit.assertEquals(Token.TokenShape.CIRCLE, TokenUtil.guessTokenType(img));
		...
		AssertJUnit.assertEquals(Token.TokenShape.TOP_DOWN, TokenUtil.guessTokenType(img));
	}
}
