...
public class AppUtilTest extends TestCase {
	...
	public void testGetAppHome() throws Exception {
		 ...
		 * tabletoptool data directory. We delete the non-default
		 * tabletoptool data directory first, check to see if 
		...
		// Remove REL_DIR_ALT.
		subDir.delete();
		// Remove the default tabletoptool directory. This will
